...
const Software = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto space-y-6 pb-10 text-gray-500 max-lg:m-4'>
            ...
            <h2 className='max-lg:text-2xl lg:text-3xl font-bold '>Features Of Our <span className='text-green-600'>{data?.name}</span>:</h2>
            <ul className='text-xl list-disc ml-4 text-black'>
                ...
                <h2 className='max-lg:text-2xl lg:text-3xl font-bold max-lg:py-8 lg:py-16 text-gray-500'>For additional features or more details about <span className='text-green-600'>{data?.name}</span>. <br /> please call us : <br /> <span className='text-red-600 italic	'>+8801710-822207, +8801872-884988</span> <br /> ( 08AM to 10PM )</h2>
        </div>
    );
};
