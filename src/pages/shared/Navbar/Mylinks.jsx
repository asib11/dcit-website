export const links = [
    ...
    // },
    {
        ...
        sublinks: [
          {
            Head: "Softwares",
            sublink: [
              { name: "Restaurant Management Software", link: "/software/restaurantManagementSoftware" },
              { name: "Accounting Software", link: '/software/accountingSoftware' },
              { name: "Inventory Software", link: '/software/inventorySoftware' },
              { name: "Human Resource Management Software", link: '/software/humanResourceManagementSoftware' },
              { name: "Medicine Store Application", link: '/software/medicineStoreApplication' },
              { name: "Billing Automation Software", link: '/software/billingAutomationSoftware' },
              { name: "School College Management Software", link: '/software/schoolCollegeManagementSoftware' },
              { name: "Enterprise Resource Planning (ERP)", link: '/software/erp' },
              { name: "Payroll Software", link: '/software/payrollSoftware' },
              { name: "Client Management Software", link: '/software/clientManagementSoftware' },
              { name: "Real Estate Software", link: '/software/realEstateSoftware' },
              { name: "SMS Marketing Software", link: '/software/SMSMarketingSoftware' },
            ],
          },
        ],
      },
      ...
      //       Head: "Hosting",
      //       sublink: [
      //         { name: "Shared Hosting", link: "/hosting/sharedHosting" },
